...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_lvls.setText(R.string.Level3); // установили текст
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level3.this, LvlMenu.class);
        ...
        TextView txt_description_win = (TextView) dialogEnd.findViewById(R.id.txt_end_descripton_win);
        txt_description_win.setText(R.string.end_lvl3);
        ...
        flagAnswer = taskImg;
        imgTask.setImageResource(arrayLvl.task_lvl3[taskImg]); //добавляю картинку
        ...
        btn_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if ((flagAnswer == 0) || (flagAnswer == 1) || (flagAnswer == 4)){
                    ...
                    if((flagAnswer == 0) || (flagAnswer == 1) || (flagAnswer == 4)){
                        ...
                        if (count == 1) {
                            ...
                            if(level > 3){
                                ...
                                editor.putInt("Level", 4); //пишем цифру след уровня
                                editor.commit();
                            }
                            dialogEnd.show(); //показ д.о в конце уровня при прохождении
                        }
                    }else if ((flagAnswer != 0) || (flagAnswer != 1) || (flagAnswer != 4)){
                        count = 0;
        ...
        btn_right.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    }else if ((flagAnswer != 2) || (flagAnswer != 3)){
                        count = 0;
