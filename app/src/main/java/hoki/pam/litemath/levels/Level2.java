...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_lvls.setText(R.string.Level2); // установили текст
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level2.this, LvlMenu.class);
        ...
        txt_description_win.setText(R.string.end_lvl2);
        ...
        flagAnswer = taskImg;
        imgTask.setImageResource(arrayLvl.task_lvl2[taskImg]); //добавляю картинку
                    ...
                    if((flagAnswer == 0) || (flagAnswer == 1) || (flagAnswer == 4)){
                        ...
                        if (count == 1) {
                            ...
                            if(level > 2){
                                ...
                                editor.putInt("Level", 3); //пишем цифру след уровня
                                editor.commit();
                            }
