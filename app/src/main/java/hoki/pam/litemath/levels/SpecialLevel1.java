...
public class SpecialLevel1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_lvl1);
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(SpecialLevel1.this, SpecialLvlMenu.class);
        ...
        btn_close_end_losing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(SpecialLevel1.this, SpecialLevel1.class);
                    startActivity(intent);
                    finish();
        ...
        btn_continue_special_task.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(SpecialLevel1.this, SpecialLevel1Task1.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
        ...
        Button btn_special_inv_lvl1 = (Button)findViewById(R.id.btn_special_inv_lvl1);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    Intent intent = new Intent(SpecialLevel1.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
