...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_lvls.setText(R.string.Level4); // установили текст
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level4.this, LvlMenu.class);
        ...
        txt_description_win.setText(R.string.end_lvl4);
        ...
        flagAnswer = taskImg;
        imgTask.setImageResource(arrayLvl.task_lvl4[taskImg]); //добавляю картинку
                    ...
                    if((flagAnswer == 0) || (flagAnswer == 1)){
                        ...
                        if (count == 1) {
                            ...
                            if(level > 4){
                                ...
                                editor.putInt("Level", 5); //пишем цифру след уровня
                                editor.commit();
                            }
                            dialogEnd.show(); //показ д.о в конце уровня при прохождении
                        }
                    }else if ((flagAnswer != 0) || (flagAnswer != 1)){
                        count = 0;
        ...
        btn_right.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if ((flagAnswer == 2) || (flagAnswer == 3) || (flagAnswer == 4)){
                    ...
                    }else if ((flagAnswer != 2) || (flagAnswer != 3) || (flagAnswer != 4)){
                        count = 0;
