...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_lvls.setText(R.string.Level5); // установили текст
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level5.this, LvlMenu.class);
        ...
        flagAnswer = taskImg;
        imgTask.setImageResource(arrayLvl.task_lvl5[taskImg]); //добавляю картинку
                    ...
                    if((flagAnswer == 0) || (flagAnswer == 1)){
                        ...
                        if (count == 1) {
                            ...
                            if(level > 5){
                                ...
                                editor.putInt("Level", 6); //пишем цифру след уровня
                                editor.commit();
                            }
