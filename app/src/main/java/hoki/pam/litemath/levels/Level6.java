...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_lvls.setText(R.string.Level6); // установили текст
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level6.this, LvlMenu.class);
        ...
        flagAnswer = taskImg;
        imgTask.setImageResource(arrayLvl.task_lvl6[taskImg]); //добавляю картинку
                    ...
                    if((flagAnswer == 0) || (flagAnswer == 1) || (flagAnswer == 2)){
                        ...
                        if (count == 1) {
                            ...
                            if(level > 6){
                                ...
                                editor.putInt("Level", 7); //пишем цифру след уровня
                                editor.commit();
                            }
