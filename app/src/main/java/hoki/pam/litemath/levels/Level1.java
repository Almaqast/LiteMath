...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_lvls.setText(       R.string.Level1); // установили текст
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level1.this, LvlMenu.class);
        ...
        flagAnswer = taskImg;
        imgTask.setImageResource(arrayLvl.images1[taskImg]); //добавляю картинку
        ...
        btn_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if ((flagAnswer == 0) || (flagAnswer == 2) || (flagAnswer == 3)){
                    ...
                    if((flagAnswer == 0) || (flagAnswer == 2) || (flagAnswer == 3)){
                        ...
                        if (count == 1) {
                            ...
                            if(level > 1){
                                ...
                                editor.putInt("Level", 2); //пишем цифру след уровня
                                editor.commit();
                            }
                            dialogEnd.show(); //показ д.о в конце уровня при прохождении
                        }
                    }else if ((flagAnswer != 0) || (flagAnswer != 2) || (flagAnswer != 3)){
                        count = 0;
        ...
        btn_right.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    }else if ((flagAnswer != 1) || (flagAnswer != 4)){
                        count = 0;
