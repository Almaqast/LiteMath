...
public class SpecialLevel1Task1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__special_lvl1_task1);

        TextView txt_special_task_lvl1 = (TextView)findViewById(R.id.txt_special_task_lvl1);
        txt_special_task_lvl1.setText(R.string.lvl1_special);

        Button btn_back_special_task_lvl1 = (Button)findViewById(R.id.btn_back_special_task_lvl1);

        btn_back_special_task_lvl1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(SpecialLevel1Task1.this, SpecialLevel1.class);
        ...
        btn_close_end_lvl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(SpecialLevel1Task1.this, MainActivity.class);
                    startActivity(intent);
                    finish();
        ...
        btn_continue_end_lvl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(SpecialLevel1Task1.this, SpecialLevel2Task1.class);
                    startActivity(intent);
                    finish();
        ...
        final Animation animation = AnimationUtils.loadAnimation(SpecialLevel1Task1.this, R.anim.alpha);

        final ImageView imgTask_left_special_lvl1 = (ImageView)findViewById(R.id.imgTask_top_special_task_lvl1);
        final ImageView imgTask_right_special_lvl1 = (ImageView)findViewById(R.id.imgTask_bot_special_task_lvl1);
        imgTask_left_special_lvl1.setClipToOutline(true);
        imgTask_right_special_lvl1.setClipToOutline(true);


        numLeft = random.nextInt(6);
        imgTask_left_special_lvl1.setImageResource(arrayLvl_special_lvl1.img_sp_task_lvl1[numLeft]);
        ...
        imgTask_right_special_lvl1.setImageResource(arrayLvl_special_lvl1.img_sp_task_lvl1[numRight]);
